...
app.post("/activity/get",require("./activity/get/route"));
app.post("/subjectTerm/get",require("./subjectTerm/get/route"));
app.post("/subject/listSigned",require("./subject/listSigned/route"));
